...
{
    public class ResetPassword_IncorrectResetToken_ShouldReturnBadRequest_Test : BaseIntegrationTest
    {
        public ResetPassword_IncorrectResetToken_ShouldReturnBadRequest_Test(IntegrationTestWebAppFactory factory) : base(factory) { }
